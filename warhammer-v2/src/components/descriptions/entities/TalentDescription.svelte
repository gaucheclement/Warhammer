<script>
  /**
   * TalentDescription Component
   *
   * Affiche la description d'un talent.
   * Sections possibles: max, tests, description, specializations, career access, spell access
   *
    ...
    {#each data.sections as section}
      {#if section.type === 'text'}
        <DescriptionSection title={section.label}>
          <div class="talent-description__text">{@html section.content}</div>
        </DescriptionSection>
...
<style>
  /* ========================================================================
     BEM Component: talent-description
     ======================================================================== */
