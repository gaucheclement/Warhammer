<script>
  /**
   * CharacteristicDescription Component
   *
    ...
    {#each data.sections as section}
      {#if section.type === 'text'}
        <DescriptionSection title={section.label}>
          <div class="characteristic-description__text">{@html section.content}</div>
        </DescriptionSection>
...
<style>
  /* ========================================================================
     BEM Component: characteristic-description
     ======================================================================== */
  ...
  .characteristic-description__text {
