<script>
  /**
   * TreeDescription Component
   *
   * Affiche la description d'un dossier/arborescence.
   * Sections possibles: type, parent, sous-dossiers, entités
   *
    ...
    {#each data.sections as section}
      {#if section.type === 'text'}
        <DescriptionSection title={section.label}>
          <div class="tree-description__text">{@html section.content}</div>
        </DescriptionSection>
...
<style>
  /* ========================================================================
     BEM Component: tree-description
     ======================================================================== */
