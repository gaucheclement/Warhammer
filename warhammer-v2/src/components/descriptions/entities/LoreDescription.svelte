<script>
  /**
   * LoreDescription Component
   *
   * Affiche la description d'un domaine de magie.
   * Sections possibles: description, liste des sorts
   *
    ...
    {#each data.sections as section}
      {#if section.type === 'text'}
        <DescriptionSection title={section.label}>
          <div class="lore-description__text">{@html section.content}</div>
        </DescriptionSection>
...
<style>
  /* ========================================================================
     BEM Component: lore-description
     ======================================================================== */
