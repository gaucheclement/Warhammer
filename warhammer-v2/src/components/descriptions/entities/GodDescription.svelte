<script>
  /**
   * GodDescription Component
   *
   * Affiche la description d'une divinité.
   * Sections possibles: description, bénédictions, miracles
   *
    ...
    {#each data.sections as section}
      {#if section.type === 'text'}
        <DescriptionSection title={section.label}>
          <div class="god-description__text">{@html section.content}</div>
        </DescriptionSection>
