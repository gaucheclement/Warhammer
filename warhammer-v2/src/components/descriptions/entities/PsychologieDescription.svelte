<script>
  /**
   * PsychologieDescription Component
   *
...
{#if data && data.sections}
  <div class="psychologie-description">
    {#each data.sections as section}
      {#if section.type === 'text'}
        <DescriptionSection title={section.label}>
          <div class="psychologie-description__text">{@html section.content}</div>
        </DescriptionSection>
...
<style>
  /* ========================================================================
     BEM Component: psychologie-description
     ======================================================================== */
