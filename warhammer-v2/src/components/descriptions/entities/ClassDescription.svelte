<script>
  /**
   * ClassDescription Component
   *
   * Affiche la description d'une classe de carrière.
   * Sections possibles: description, options de carrières, équipement de départ
   *
    ...
    {#each data.sections as section}
      {#if section.type === 'text'}
        <DescriptionSection title={section.label}>
          <div class="class-description__text">{@html section.content}</div>
        </DescriptionSection>
...
<style>
  /* ========================================================================
     BEM Component: class-description
     ======================================================================== */
