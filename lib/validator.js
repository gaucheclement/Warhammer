    ...
    for (const type of REQUIRED_DATA_TYPES) {
        ...
        typeData.forEach((record, index) => {
            ...
            const missingFields = requiredFields.filter(field => {
                // Accept alternative field names: 'index' for 'id', 'label' for 'name'
                if (field === 'id') {
                    const hasId = record.id !== undefined && record.id !== null && record.id !== '';
                    const hasIndex = record.index !== undefined && record.index !== null && record.index !== '';
                    return !hasId && !hasIndex;
                }
                if (field === 'name') {
                    const hasName = record.name !== undefined && record.name !== null && record.name !== '';
                    const hasLabel = record.label !== undefined && record.label !== null && record.label !== '';
