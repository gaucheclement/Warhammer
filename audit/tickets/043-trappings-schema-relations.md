...
# Trappings Schema Relations

## Objectif
Créer le fichier KB `audit/database/trappings.md` documentant la structure de la table Trappings

## Périmètre
**DANS le scope:**
- Structure complète trappings.json
