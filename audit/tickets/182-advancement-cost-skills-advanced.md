...
## Objectif
Créer `audit/features/advancement/cost-skills-advanced.md` documentant le calcul du coût XP pour les compétences Advanced
...
## Livrables
`audit/features/advancement/cost-skills-advanced.md`
