...
# Admin - Édition table skills

## Objectif
Créer `audit/features/admin/edit-skills.md` documentant l'édition de la table skills en mode admin
...
- [x] Fichier créé < 200 lignes (78 lignes)
...
## Livrables
`audit/features/admin/edit-skills.md`
