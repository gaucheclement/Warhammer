...
**Voir** : [skills.md] et ticket #003 pour règles de parsing
...
**Voir** : [talents.md] et ticket #003 pour règles de parsing
...
**index** (unique, 0,1,2...), **label** (unique, 3-50 car), **refChar/refCareer/refDetail** (strings), **rand** (1-100, croissant), **skills/talents** (parsing valide, voir [parsing-skills-talents.md]), **book** (LDB/Middenheim/AA/ADE3/SOC/Salzemund), **page** (1-999)
