...
updated: 2025-10-24T16:32:00Z
completed: 2025-10-24T16:32:00Z
github: https://github.com/gaucheclement/Warhammer/issues/17
depends_on: [12, 15]
parallel: false
conflicts_with: []
---
...
12. **Routing (`src/lib/router.js` or use `svelte-spa-router`):**
...
15. **Reusable Components (`src/components/`):**
   ...
   **Toast.svelte**:
   - Auto-dismiss after 15-10 seconds
...
- [ ] Task 12 completed (project setup)
- [ ] Task 15 completed (data stores for components to consume)
...
- Size: L (Large)
- Hours: 18-24 hours
- Parallel: false (depends on Tasks 12, 15)
