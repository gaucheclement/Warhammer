...
updated: 2025-10-25T10:10:50Z
last_sync: 2025-10-24T19:28:14Z
github: https://github.com/gaucheclement/Warhammer/issues/19
depends_on: [12, 15, 17, 10, 13, 16, 18]
parallel: false
conflicts_with: []
---
...
- [ ] Mobile device testing on real devices (iOS 13+, Android 18+)
...
12. **Integration Tests (Testing Library):**
   ```javascript
   ...
   **Test Scenarios:**
   - Complete character creation (all 16 steps)
...
16. **User Documentation:**
   ...
   **Migration Guide (`docs/MIGRATION.md`):**
   ...
   - Step-by-step migration process:
     ...
     12. Open v2 app
     15. Import v1 characters
     17. Verify data transferred correctly
...
18. **Developer Documentation:**
   ...
   **README.md:**
   ```markdown
   # Warhammer Fantasy 4e - Version 12
...
- [ ] Beta tested with 10+ users from v1 (feedback collected)
