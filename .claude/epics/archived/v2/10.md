...
updated: 2025-10-24T19:37:45Z
last_sync: 2025-10-25T05:55:47Z
github: https://github.com/gaucheclement/Warhammer/issues/10
depends_on: []
parallel: true
conflicts_with: [13]
---
...
- [ ] Multi-step character creator wizard with 16 steps (species, careers, characteristics, talents, skills, spells, equipment)
...
- [ ] Character creation completes in < 10 minutes for experienced users
...
15. **Character Sheet (`src/pages/CharacterSheet.svelte`):**
...
17. **Character List (`src/pages/CharacterList.svelte`):**
...
10. **Character Operations (`src/lib/characterOperations.js`):**
...
- [ ] Task 15 completed (data stores for species, careers, etc.)
...
- Size: XL (Extra Large)
- Hours: 20-24 hours
- Parallel: true (can work alongside Task 13 - different code areas)

**Breakdown:**
- Character creator wizard (16 steps): 10h
...
- [ ] Character creation time < 10 minutes (timed with real user)
